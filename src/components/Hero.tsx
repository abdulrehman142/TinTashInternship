        ...
        >
          ...
          <div className=" sticky top-0 flex text-white p-2 m-2 w-full z-[999]">
            ...
            <div className="flex items-start  p-2">
              ...
              <h1
                className="uppercase text-[24px] leading-[15px]"
          ...
          <div className="top-0 flex flex-col items-center justify-center">
            ...
            <div className="p-4 m-8">
              <h1
                className="font-semibold text-[#FFFFFF] xl:text-[54px] text-center xl:leading-[62px] pt-16"
                style={{
                  fontFamily: '"IBM Plex Mono", monospace',
            ...
            <div
              className="p-4 flex flex-wrap items-center justify-center leading-4 w-180"
              style={{
                fontFamily: '"IBM Plex Mono", monospace',
                fontWeight: 500,
                fontSize: "16px",
